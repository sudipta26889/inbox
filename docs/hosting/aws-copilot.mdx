...
description: 'Deploy Inbox to AWS using AWS Copilot and ECS Fargate'
---

Deploy Inbox to AWS using AWS Copilot. The deployment uses Amazon ECS on Fargate.
...
- Inbox repository cloned locally (run all commands from the repo root)
