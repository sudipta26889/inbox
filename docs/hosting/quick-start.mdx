---
title: 'Quick Start'
description: 'Self-host Inbox in under 5 minutes'
---

The fastest way to self-host Inbox is with two commands:
...
Need to remove Inbox or start fresh? See the [full cleanup guide](/hosting/troubleshooting#uninstalling--starting-over) in Troubleshooting.
