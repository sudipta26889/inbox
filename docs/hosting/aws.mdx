...
description: 'Choose the right AWS deployment method for Inbox'
---

There are three ways to deploy Inbox on AWS. Choose the one that fits your team and infrastructure.
