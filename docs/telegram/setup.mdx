...
description: "Set up the Telegram bot for Inbox assistant chat."
---

# Telegram Integration Setup

This guide is for self-hosted deployments that want to enable Telegram chat with the Inbox assistant.
...
Set your bot's webhook to Inbox:
...
Each Inbox email account links to a Telegram user via a connect code:
