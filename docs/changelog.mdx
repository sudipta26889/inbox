---
title: "Changelog"
description: "Latest updates and improvements to Inbox"
---

<Update label="March 15, 2026" description="Command-Line Automation">
  You can now manage your inbox from the terminal with the new Inbox CLI. Install it via npm to automate rules, check stats, and control your setup without opening the browser.
...
<Update label="March 11, 2026" description="Auto-File Every Attachment">
  ...
  - Sync your label rules to the Inbox Tabs browser extension with one click
