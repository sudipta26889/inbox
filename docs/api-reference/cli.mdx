---
title: "CLI"
description: "Use the Inbox API CLI from npm or npx."
---

Use the Inbox API CLI when you want a thin wrapper around the public API for scripts, bots, or local automation.
...
`base-url` is optional. The CLI defaults to `https://www.inbox.sudiptadhara.in` and only needs an override for self-hosted or custom deployments.
