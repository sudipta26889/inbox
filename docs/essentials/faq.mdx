...
Answers to common questions about Inbox.
...
To add more email addresses to your account, please visit the [Settings](https://www.inbox.sudiptadhara.in/settings) page in the left sidebar.
Then in the `Share Premium`, add the emails you'd like to share your premium with.
Each email address you add must first sign up to Inbox, and then you can add them to your account.
...
- Search for `Inbox`, click on it, and then click `See Details`
...
- Find `Inbox` in the list and click on it
- Click `Remove` to revoke access

If you don't see `Inbox` in the list, it means the account is not connected to Inbox.
...
1. **Use the [Inbox Tabs Extension](/essentials/inbox-zero-tabs-extension)** - Our free browser extension adds custom tabs to Gmail, letting you organize emails by type (newsletters, receipts, to reply, etc.). It works great with our AI assistant which can automatically label emails for the tabs.

   ![Inbox Tabs Extension](/images/extension.png)
...
To delete your account, please visit the [Settings](https://www.inbox.sudiptadhara.in/settings) page in the left sidebar.
Then in the `Delete Account` section, click on the `Delete Account` button.

### How do I cancel my subscription?

To cancel your subscription, please visit the [Settings](https://www.inbox.sudiptadhara.in/premium) page in the left sidebar.
