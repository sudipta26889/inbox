...
Inbox Tabs is a free browser extension that adds custom tabs to Gmail. It helps you organize your inbox by creating tabs for different types of emails - similar to Superhuman's split inbox feature.
...
<Info>
  When used with [Inbox's AI Assistant](/essentials/email-ai-personal-assistant), the extension becomes extra powerful. The AI can automatically categorize and label your emails, which then appear in the appropriate tabs without any manual setup.
</Info>
...
[Get Inbox Tabs Extension](https://go.inbox.sudiptadhara.in/extension)

Works with Chrome, Brave, Arc, Edge, Opera, and other Chromium-based browsers.

### Firefox
[Get Inbox Tabs for Firefox](https://go.inbox.sudiptadhara.in/firefox)
...
Need help? Contact us at [elie@inbox.sudiptadhara.in](mailto:elie@inbox.sudiptadhara.in) or visit our [support page](https://inbox.sudiptadhara.in).
