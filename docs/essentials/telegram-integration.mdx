...
Connect Telegram to Inbox to chat with your AI email assistant directly from Telegram. Ask questions about your inbox, draft emails, manage rules, and more — all from a Telegram DM.
...
4. Open a direct message with the Inbox bot in Telegram
...
- `/connect` — Link your Inbox account
