...
Add a delayed action to any rule in [AI Personal Assistant](https://www.inbox.sudiptadhara.in/automation). When an email matches the rule, the action will be performed after the delay you specify.
