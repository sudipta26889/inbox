...
To set up AI Personal Assistant for your email, click on the `AI Personal Assistant` tab in the left sidebar. Or visit [this link](https://www.inbox.sudiptadhara.in/automation).
...
On the [Rules](https://www.inbox.sudiptadhara.in/automation?tab=rules) page, you can view and edit your rules.
...
You can test your rules by going to the [Test](https://www.inbox.sudiptadhara.in/automation?tab=test) tab.
