...
Inbox's calendar integration enables the AI assistant to draft email responses based on your actual calendar availability. It checks all your connected calendars (work and personal) and suggests available time slots or includes your booking link — eliminating scheduling back-and-forth.
