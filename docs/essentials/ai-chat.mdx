...
The AI Chat is the primary way to interact with Inbox. Tell it what you need in plain English and it handles the rest — no menus or settings pages required.

To get started, click `Assistant` in the left sidebar or visit [this link](https://www.inbox.sudiptadhara.in/assistant).
