---
title: 'Contributing'
description: 'Set up Inbox for local development'
---

This guide is for developers who want to run Inbox locally and contribute to the project.

<iframe
  width="560"
  height="315"
  src="https://www.youtube.com/embed/hVQENQ4WT2Y"
  title="Set up Inbox locally"
  frameBorder="0"
...
View open tasks in [GitHub Issues](https://github.com/elie222/inbox-zero/issues) and join the [Discord](https://www.inbox.sudiptadhara.in/discord) to discuss what's being worked on.
