...
description: "Set up the Teams bot for Inbox assistant chat."
---

# Microsoft Teams Integration Setup

This guide is for self-hosted deployments that want to enable Teams chat with the Inbox assistant.

## What Teams currently supports

- AI assistant chat in **direct messages** with the Inbox bot
...
```json
{
  ...
  "description": {
    ...
    "full": "Chat with your Inbox AI assistant directly from Teams."
  },
  "icons": {
    "outline": "outline.png",
    "color": "color.png"
...
## 7. Connect a user account from Inbox

Each Inbox email account links to a Teams user via a connect code:

1. In Inbox, go to **Settings** → **Connected Apps**
2. Click **Connect Teams**
3. Copy the generated command: `/connect <code>`
4. Open a DM with the Inbox bot in Teams
5. Send the command
